...
do
	...
	do
        	...
        	echo "vcftools --vcf /home/apcar/starling_gbs/vcf/mergedSNPs2/filter/minDP/snps_"$i"_"$x"_1.recode.vcf --out /home/apcar/starling_gbs/vcf/mergedSNPs2/filter/minDP/snps_"$i"_"$x"_2 --remove /home/apcar/starling_gbs/vcf/mergedSNPs2/filter/minDP/snps_"$i"_"$x"_1rmID.txt --recode" >> temp.sh
