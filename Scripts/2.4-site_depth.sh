...
do
	...
	do
        	...
        	echo "vcftools --vcf /home/apcar/starling_gbs/vcf/mergedSNPs2/filter/minDP/snps_"$i"_"$x"_1.recode.vcf --site-depth -c > /home/apcar/starling_gbs/vcf/mergedSNPs2/filter/minDP/snps_"$i"_"$x"_1site.txt" >> temp.sh
